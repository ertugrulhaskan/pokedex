...
const Search = () => {
  return (
    <form className="relative flex w-full flex-row">
      ...
      />
      <button className="absolute top-1.5 right-2 flex h-7 w-7 flex-row items-center justify-center rounded-full text-center text-xl text-zinc-400 hover:bg-zinc-400 hover:text-white">
        <MdOutlineClear />
      </button>
    </form>
  );
